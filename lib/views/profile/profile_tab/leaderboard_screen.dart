            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      _tabButton("Weekly", true),
                      _tabButton("Monthly", false),
                      _tabButton("All Time", false),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: const [
                      ...
                      Text("CO₂e Saved", style: TextStyle(color: Colors.white)),
                    ],
                  ),
                ),
                ...
                // Ranking Cards
                _rankingTile("Huzaifa Arain", "Gold", 152.4, 36.2, context),
                _rankingTile("Huzaifa Arain", "Silver", 152.4, 36.2, context),
                _rankingTile("Huzaifa Arain", "Bronze", 152.4, 36.2, context),
                ...
                _yourRankTile("Huzaifa Arain", 41.8, 9.3, context),
