...
class Palette {
  static const MaterialColor themecolor = MaterialColor(
    0xff3758a7, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
      50: Color(0xff2c63d1), //10%
      100: Color(0xff5a8bed), //20%
      200: Color(0xff83a8f1), //30%
      300: Color(0xff17899c), //40%
  ...
  static const Color primaryColor = Color(0XFF4834AA);
  static const Color secondaryColor = Color(0XFF1D8AA2);
}

const themeblackcolor = Color(0xff101010);
const themetextfieldolor = Color(0xffF1F4FF);
...
const themegreencolor1 = Color(0xff059212);
...
const themebrowncolor2 = Color(0xffc79e52);
