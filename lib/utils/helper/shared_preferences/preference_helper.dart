...
import 'package:carbon_fora/utils/helper/shared_preferences/preferences_utils.dart';
import 'package:synchronized/synchronized.dart';

class SharedPrefHelper {
  static SharedPrefHelper? _singleton;
  static SharedPreferences? _prefs;
  static final Lock _lock = Lock();
  static SharePrefUtils utils = SharePrefUtils();

  static Future<SharedPrefHelper?> getInstance() async {
    if (_singleton == null) {
      await _lock.synchronized(() async {
        if (_singleton == null) {
          var singleton = SharedPrefHelper._();
